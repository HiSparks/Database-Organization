...
Пример. Пусть имеется отношение Student (Id, Name, Enter_Year, Age, Id_Group, Average_Mark). Создать представление, скрывающее информацию о годе поступления (атрибут Enter_Year) и о возрасте (атрибут Age), а также изменяющее имена некоторых атрибутов.
...
![Рисунок 11.1 – Укрупненная структура расположения данных в БД (по умолчанию БД имеет два файла – физический файл БД (\*.mdf), - файл журнала (\*.ldf))](../assets/images/11-01.jpg)
...
![Рисунок 11.2 – Двусвязный список для организации страниц данных кластерной таблицы на SQL-сервере](../assets/images/11-02.jpg)

Рисунок 11.2 – Двусвязный список для организации страниц данных кластерной таблицы на SQL-сервере
...
![Рисунок 11.3 – Процесс разбиения (расщепления) страницы кластерного индекса](../assets/images/11-03.jpg)
