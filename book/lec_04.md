...
1. определить структуру новой таблицы и создать эту таблицу,
2. изменить определение существующей таблицы,
3. удалить существующую таблицу,
4. определить представление данных, 
5. обеспечить условия безопасности БД,
6. создать индексы для доступа к таблицам,
7. управлять размещением данных на устройствах хранения.
...
| Предоаставить право    | Удалить право             |
|------------------------|---------------------------|
| GRANT                  | REVOKE                    |
