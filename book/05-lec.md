...
![Рисунок 5.2 − Связь один-ко-многим между полями таблиц GROUPS и STUDENT](../assets/images/05-02.jpg)
...
6. Вставка даты/времени в таблицу БД (таблица 5.1).
	...
	INSERT INTO USP(ID, ID_NUM, OCENKA, ID_PREDM, CDATE )
		VALUES(1, 3001, 3, 1, '2010/05/19') --(формат ‘YYYY/MM/DD’)
	```
	Или так 
	```sql
	...
	`Select id, ('дата '+ tdate) As 'Date' From TTime`. Данный оператор Select не выполнится, будет ошибка преобразования:
